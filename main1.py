...
arcade.draw_ellipse_filled(320,350,15,25,open_color.black)
arcade.draw_ellipse_filled(375,350,15,25,open_color.black)
arcade.draw_circle_filled(320,355,3,open_color.gray_2)
arcade.draw_circle_filled(375,355,3,open_color.gray_2)

#(x,y,width,height,color,start_degrees,end_degrees,border_thickness)
arcade.draw_arc_outline(350,325,60,50,open_color.black,190,350,4)
